...
import { Menu, X, Ticket, LogOut, User, Search, Shield } from "lucide-react";
          ...
          {mobileOpen && (
            ...
            >
              <div className="container mx-auto flex flex-col gap-1 px-4 py-4">
                ...
                {admin && (
                  <Link to="/admin" onClick={() => setMobileOpen(false)} className="block px-3 py-2 text-sm font-medium rounded-md text-primary bg-primary/10">
